...
var PqcMiner pqcminer

func (pqcminer) Type() string {
	return "pqcminer"
}

func (pqcminer) Config() interface{} {
	return &struct{}{}
}

func (pqcminer) APIFlags() []string {
	panic("not supported")
}

func (pqcminer) RepoFlags() []string {
	panic("not supported")
}

func (pqcminer) APIInfoEnvVars() (primary string, fallbacks []string, deprecated []string) {
	panic("not supported")
}
