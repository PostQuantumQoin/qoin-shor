...
#pragma message("DILITHIUM_MODE == 3")
#define K 6
#define L 5
#define ETA 4
#define TAU 49
...
#pragma message("DILITHIUM_MODE == 5")
#define K 8
#define L 7
#define ETA 2
#define TAU 60
...
*/
#if DILITHIUM_MODE == 2
#pragma message("DILITHIUM_MODE == 2 CRYPTO_PUBLICKEYBYTES")
#define CRYPTO_PUBLICKEYBYTES 1312
#define CRYPTO_SECRETKEYBYTES 2544
#define CRYPTO_BYTES 2420

#elif DILITHIUM_MODE == 3
#pragma message("DILITHIUM_MODE == 3 CRYPTO_PUBLICKEYBYTES")
#define CRYPTO_PUBLICKEYBYTES 1952
#define CRYPTO_SECRETKEYBYTES 4016
#define CRYPTO_BYTES 3293

#elif DILITHIUM_MODE == 5
#pragma message("DILITHIUM_MODE == 5 CRYPTO_PUBLICKEYBYTES")
